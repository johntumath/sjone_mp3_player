 ...
 ******************************************************************************/
#define TRC_CFG_SYMBOL_TABLE_SLOTS 64
 ...
 * (as User Events) from TzCtrl task, that monitors this.
 ******************************************************************************/
#define TRC_CFG_SYMBOL_MAX_LENGTH 24
 ...
 ******************************************************************************/
#define TRC_CFG_OBJECT_DATA_SLOTS 64
 ...
 ******************************************************************************/
#define TRC_CFG_CTRL_TASK_STACK_SIZE (STACK_BYTES(1280))
 ...
 *
 * Note: Smaller buffer will write the file a lot and use a lot of CPU, for instance:
 * 512 * 10 consumed the CPU 80% at 96Mhz
 * 2048 * 4 consumed the CPU 31%
 * 4096 * 3 consumed the CPU 18%
 ******************************************************************************/
 ...
 * Note: not used by the J-Link RTT stream port (see SEGGER_RTT_Conf.h instead)
 ******************************************************************************/
#define TRC_CFG_PAGED_EVENT_BUFFER_PAGE_SIZE 4096
